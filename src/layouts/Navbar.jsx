        ...
        <Flex>
          ...
          <div className='w-5/12 '>
            <ul className='flex gap-x-12 cursor-pointer'>
              <ListItem className="hover:underline text-black" text="Home" />
              <ListItem className="hover:underline text-black" text="Contact" />
              <ListItem className="hover:underline text-black" text="About" />
              <ListItem className="hover:underline text-black" text="Sign Up" />
            </ul>
          </div>
